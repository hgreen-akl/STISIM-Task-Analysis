...
run_tests_by_saccade <- function (database,var){
no_of_bins <- database_by_saccade %>% distinct(saccade_number) %>% count() %>% as.numeric()
bins_df <- seq_along(no_of_bins)
     tests_func <- function (bin_num,var) {
 ...
 Fam_t_test_mean <- mean(Fam_t_test$var)
 T1_R1_t_test_mean <- mean(T1_R1_t_test$var)
 T1_R2_t_test_mean <- mean(T1_R2_t_test$var)
 T2_R1_t_test_mean <- mean(T2_R1_t_test$var)
 T2_R2_t_test_mean <- mean(T2_R2_t_test$var)

 Fam_t_test_sd <- sd(Fam_t_test$var)
 T1_R1_t_test_sd <- sd(T1_R1_t_test$var)
 T1_R2_t_test_sd <- sd(T1_R2_t_test$var)
 T2_R1_t_test_sd <- sd(T2_R1_t_test$var)
 T2_R2_t_test_sd <- sd(T2_R2_t_test$var)
 
 df_to_return <- data_frame(Fam_t_test_mean,T1_R1_t_test_mean,T1_R2_t_test_mean,T2_R1_t_test_mean, T2_R2_t_test_mean,
