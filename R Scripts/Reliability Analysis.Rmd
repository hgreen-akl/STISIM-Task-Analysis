...
p3 <- ggplot(database_by_saccade, aes(x = avg_lanepos +6, y = Trial, color = Run, point_color = Run, fill = Run, height = ..density..)) + geom_density_ridges(jittered_points = FALSE, quantile_lines = TRUE, scale = 0.7, 
