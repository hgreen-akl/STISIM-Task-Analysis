...
driving_perf_by_distance <- read_csv("G:\\Shared drives\\Projects\\2018 Driving Sim Reproducibility\\binned_by_dist_100_final.csv")

driving_perf_by_saccade <- read_csv("G:\\Shared drives\\Projects\\2018 Driving Sim Reproducibility\\binned_by_saccade_100_final.csv")

filtered_driving_perf_by_distance <- read_csv("G:\\Shared drives\\Projects\\2018 Driving Sim Reproducibility\\binned_by_dist_100_filtered_final.csv")
...
KSS_data <- read_excel(path = "G:\\Shared drives\\Projects\\2018 Driving Sim Reproducibility\\KSS Scores.xlsx", sheet = 1) %>%
                select(1:7) %>% 
