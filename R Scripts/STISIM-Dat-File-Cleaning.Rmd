...
```{r}
list_of_files_name <- "G:\\Team Drives\\Research Team\\Projects\\2018 Driving Sim Reproducibility\\Participant Information.xlsx" 
list_of_DAT_files <- read_xlsx(list_of_files_name, sheet = "Scenario Coding") %>% 
  mutate(pattern_name = paste0(Participant,"_", Run_Number))
        
list_of_DAT_files %>% head()

DAT_to_import <- list_of_DAT_files$pattern_name
