...
if(file.exists(list.files(path = "G:/Team Drives/Research Team/Projects/2018 Driving Sim Reproducibility/3_Raw Data/",
                              pattern = paste0("?",x,"_trimmed"), recursive = TRUE, full.names = TRUE))) {
    print(paste(x , "is Trimmed"))
  
    } else {
    
  filename <- list.files(path = "G:/Team Drives/Research Team/Projects/2018 Driving Sim Reproducibility/3_Raw Data/", pattern = paste0("?",x,".Dat"), recursive = TRUE, full.names = TRUE)
