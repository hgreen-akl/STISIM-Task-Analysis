...
Filename_Database <- read_excel("G:/Shared drives/Projects/Projects/2018 Driving Sim Reproducibility/File Reference Database.xlsx", 
                                 sheet = 1)
...
find_saccade_csv_filename <- function(x) {
   y <-  list.files(path = "G:/Shared drives/Projects/2018 Driving Sim Reproducibility\\4_Analysis_Saccades\\", 
...
```{r}
saccades_database <- (read_csv("G:/Shared drives/Projects/Projects\\2018 Driving Sim Reproducibility\\4_Analysis_Saccades\\Individual_saccades_database.csv"))
...
working_csv <- "G:/Shared drives/Projects/2018 Driving Sim Reproducibility\\4_Analysis_Saccades\\working_csv.csv"
