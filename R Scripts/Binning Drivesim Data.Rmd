...
output <- as.tibble(bin_by_dist(Imported)) %>% filter(bin_duration > 0)
output2 <- output %>% mutate(Trial = as.factor("One"))


ggplot(output2, aes(x = avg_speed, y = Trial, height = ..density..)) +
