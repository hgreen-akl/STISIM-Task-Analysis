...
create_ICC_dataframe_driving <- function(database,variable,data_name){
    ...
    U_F1vsS1R1$mean_1  <- mean(U_F1[,5])
    U_F1vsS1R1$sd_1  <- sd(U_F1[,5])
    U_F1vsS1R1$mean_2  <- mean(U_S1_R1[,5])
    U_F1vsS1R1$sd_2  <- sd(U_S1_R1[,5])
    row.names(U_F1vsS1R1) <-"Fam VS S1R1"
    ...
    U_S1R1vsS1R2$mean_1  <- mean(U_S1_R1[,5])
    U_S1R1vsS1R2$sd_1  <- sd(U_S1_R1[,5])
    U_S1R1vsS1R2$mean_2  <- mean(U_S1_R2[,5])
    U_S1R1vsS1R2$sd_2  <- sd(U_S1_R2[,5])
    row.names(U_S1R1vsS1R2) <- "Within day 1"
    ...
    U_S2R1vsS2R2$mean_1  <- mean(U_S2_R1[,5])
    U_S2R1vsS2R2$sd_1  <- sd(U_S2_R1[,5])
    U_S2R1vsS2R2$mean_2  <- mean(U_S2_R2[,5])
    U_S2R1vsS2R2$sd_2  <- sd(U_S2_R2[,5])
    row.names(U_S2R1vsS2R2) <- "Within day 2"
    ...
    U_S1R1vsS2R1$t_test_p  <- t.test(data.frame(U_S2_R1[,5],U_S1_R1[,5])[,1],data.frame(U_S2_R1[,5],U_S1_R1[,5])[,2],paired = T)$
    U_S1R1vsS2R1$mean_1  <- mean(U_S1_R1[,5])
    U_S1R1vsS2R1$sd_1  <- sd(U_S1_R1[,5])
    U_S1R1vsS2R1$mean_2  <- mean(U_S2_R1[,5])
    U_S1R1vsS2R1$sd_2  <- sd(U_S2_R1[,5])
    row.names(U_S1R1vsS2R1) <- "Within run 1"
    ...
    U_S1R2vsS2R2$mean_1  <- mean(U_S1_R2[,5])
    U_S1R2vsS2R2$sd_1  <- sd(U_S1_R2[,5])
    U_S1R2vsS2R2$mean_2  <- mean(U_S2_R2[,5])
    U_S1R2vsS2R2$sd_2  <- sd(U_S2_R2[,5])
    row.names(U_S1R2vsS2R2) <- "Within run 2"
    ...
    C_F1vsS1R1$mean_1  <- mean(C_F1[,5])
    C_F1vsS1R1$sd_1  <- sd(C_F1[,5])
    C_F1vsS1R1$mean_2  <- mean(C_S1_R1[,5])
    C_F1vsS1R1$sd_2  <- sd(C_S1_R1[,5])
    ...
    C_S1R1vsS1R2$mean_1  <- mean(C_S1_R1[,5])
    C_S1R1vsS1R2$sd_1  <- sd(C_S1_R1[,5])
    C_S1R1vsS1R2$mean_2  <- mean(C_S1_R2[,5])
    C_S1R1vsS1R2$sd_2  <- sd(C_S1_R2[,5])
    ...
    C_S2R1vsS2R2$mean_1  <- mean(C_S2_R1[,5])
    C_S2R1vsS2R2$sd_1  <- sd(C_S2_R1[,5])
    C_S2R1vsS2R2$mean_2  <- mean(C_S2_R2[,5])
    C_S2R1vsS2R2$sd_2  <- sd(C_S2_R2[,5])
    ...
    C_S1R1vsS2R1$mean_1  <- mean(C_S1_R1[,5])
    C_S1R1vsS2R1$sd_1  <- sd(C_S1_R1[,5])
    C_S1R1vsS2R1$mean_2  <- mean(C_S2_R1[,5])
    C_S1R1vsS2R1$sd_2  <- sd(C_S2_R1[,5])
    ...
    C_S1R2vsS2R2$mean_1  <- mean(C_S1_R2[,5])
    C_S1R2vsS2R2$sd_1  <- sd(C_S1_R2[,5])
    C_S1R2vsS2R2$mean_2  <- mean(C_S2_R2[,5])
    C_S1R2vsS2R2$sd_2  <- sd(C_S2_R2[,5])
    row.names(C_S1R2vsS2R2) <- "Within run 2"
    
    Country_combined <- rbind(C_F1vsS1R1,C_S1R1vsS1R2,C_S2R1vsS2R2,C_S1R1vsS2R1,C_S1R2vsS2R2)
    Country_combined <- Country_combined %>% select(mean_1,sd_1,mean_2,sd_2)
